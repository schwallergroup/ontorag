...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Extract abstract and introduction sections from a markdown file."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--abstract", action="store_true", help="Extract abstract section."
    )
    parser.add_argument(
        "--introduction",
        action="store_true",
        help="Extract introduction section.",
    )
    ...
    if args.abstract:
        if args.nougat:
            ...
            abstract_file = source_path.parent / (
                source_path.stem + ".abstract.txt"
            )
    ...
    if args.introduction:
        if args.nougat:
            ...
            introduction_file = source_path.parent / (
                source_path.stem + ".introduction.txt"
            )
